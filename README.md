...
<div align="center">
<p align="center">
<img width="10%" src="src/mindwave.gif"><img width="10%" src="src/mindwave.gif"><img width="10%" src="src/mindwave.gif"><img width="10%" src="src/mindwave.gif"><img width="10%" src="src/mindwave.gif"><img width="10%" src="src/mindwave.gif"><img width="10%" src="src/mindwave.gif"><img width="10%" src="src/mindwave.gif"><img width="10%" src="src/mindwave.gif">
...
Heyyy devss, Nandani here, 19 from India and my life revolves around problems and solutions, programming and a lot of games. I mainly focus in Open Source, Web dev, Data structures and algorithms while I am still learning Game development as of 2026.✧(⸝⸝⸝ᵒ̴̶̷ ｡ ᵒ̴̶̷⸝⸝⸝)<img width="100%" src="src/m1.gif">
